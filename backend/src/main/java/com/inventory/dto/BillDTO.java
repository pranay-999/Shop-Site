...
public class BillDTO {
    ...
    public BillDTO(Long id, String billNumber, String customerName, String phoneNumber, Double subtotal, Double gstAmount, Double gstRate, String gstType, Double discount, Double totalAmount, List<BillItemDTO> items, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
